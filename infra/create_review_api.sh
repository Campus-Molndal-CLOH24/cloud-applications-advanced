...
# Variables
RESOURCE_GROUP="DemoMerchStoreRG"          # Change to your preferred resource group name
LOCATION="swedencentral"                   # Change to your preferred Azure region
